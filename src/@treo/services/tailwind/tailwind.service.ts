...
import * as extractedTailwindConfigStyle from '@treo/styles/core/tailwind-config.scss';

@Injectable()
export class TreoTailwindService
{
    ...
    constructor()
    {
        ...
        const regexpForClass = /\.treo-tailwind-extracted-config\s\{([\s\S]*)\}/g;
